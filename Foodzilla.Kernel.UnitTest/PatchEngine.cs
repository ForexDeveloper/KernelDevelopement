...
public static class PatchEngine
{
                ...
                for (int seniorId = 1; seniorId <= count; seniorId++)
                {
                    ...
                    for (int midlevelId = 1; midlevelId <= count; midlevelId++)
                    {
                        ...
                        for (int juniorId = 1; juniorId <= count; juniorId++)
                        {
                            ...
                            {
                                var fresherDeveloper = FresherDeveloper.Create(juniorId, otherLevelName, otherLevelLastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, false, uniqueIdentifier, eyeColor,
                                ...
                                var fresherProductManager = FresherProductManager.Create(juniorId, otherLevelName, otherLevelLastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, false, uniqueIdentifier, eyeColor,
                                ...
                                var fresherMarketing = FresherMarketing.Create(juniorId, otherLevelName, otherLevelLastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, false, uniqueIdentifier, eyeColor,
    ...
    public static List<ExpandoObject> CreatePatchExecutiveOfficers(List<ChiefExecutiveOfficer> chiefExecutiveOfficers)
    {
        ...
        foreach (var chiefExecutiveOfficer in chiefExecutiveOfficers)
        {
            ...
            propertyValues.Add(nameof(ChiefUnitIdentity.Id), chiefExecutiveOfficer.Id.JsonElement());
