...
public sealed class SeniorQaTesting : Identity<long>, IPatchValidator
{
    ...
    {
        return new SeniorQaTesting(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart);
    }
