...
{
    public IReadOnlyCollection<SeniorScrumMaster>? Seniors { get; private set; }
    ...
    {
        return new ScrumMasterTeamLead(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart);
    }
