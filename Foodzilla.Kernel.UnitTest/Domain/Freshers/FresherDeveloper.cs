...
public sealed class FresherDeveloper : Identity<long>, IPatchValidator
{
    ...
    {
        return new FresherDeveloper(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart);
    }
