...
public sealed class FresherProductManager : Identity<long>, IPatchValidator
{
    ...
    {
        return new FresherProductManager(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart);
    }
