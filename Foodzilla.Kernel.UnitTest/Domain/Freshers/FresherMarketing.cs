...
public sealed class FresherMarketing : Identity<long>, IPatchValidator
{
    ...
    {
        return new FresherMarketing(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart, juniorMarketingId);
    }
