...
{
    public IReadOnlyCollection<FresherProductManager>? Freshers { get; private set; }
    ...
    {
        return new JuniorProductManager(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart);
    }
