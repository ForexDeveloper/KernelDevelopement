...
public sealed class JuniorMarketing : Identity<long>, IPatchValidator
{
    ...
    public MidlevelMarketing MidlevelMarketing {get; private set; }

    public IList<FresherMarketing> Freshers => new List<FresherMarketing>();
    ...
    {
        return new JuniorMarketing(name, lastName, nationalCode, personalCode, address, age, daysOfVacation, height, weight, isFired, uniqueIdentifier, eyeColor, graduation, experience, modifiedDate, birthDate, contraDateEnd, contraDateStart, midlevelMarketingId);
    }
